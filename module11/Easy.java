...
ArrayList хранит элементы в массиве → быстрый доступ по индексу,
но вставка/удаление из середины медленные.
LinkedList хранит элементы как цепочку → быстрые вставка и удаление,
но доступ к элементу по индексу медленный.

4. Множество (Set) — коллекция, которая хранит только уникальные элементы (без дубликатов).
